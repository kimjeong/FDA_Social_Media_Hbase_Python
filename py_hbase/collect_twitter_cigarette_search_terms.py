...
#    t = oauth_login() # Returns an instance of twitter.Twitter
    ...
    tablename = "cigarette_fda_twitter_table"
    meta_cf = 'cigarette_meta_data'
    text_cf = 'cigarette_text_data'
...
if __name__ == '__main__':
    t = oauth_login_cigarette.oauth_login_cigarette()
